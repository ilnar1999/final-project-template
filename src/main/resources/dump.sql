...
-- Started on 2020-06-02 16:16:59
...
-- Name: t_cars; Type: TABLE; Schema: public; Owner: -
--
...
-- Name: t_cars_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
-- Dependencies: 210
-- Name: t_cars_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
-- Name: t_categories; Type: TABLE; Schema: public; Owner: -
--
...
-- Name: t_categories_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
-- Dependencies: 208
-- Name: t_categories_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
-- Name: t_users_roles_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
-- Dependencies: 206
-- Name: t_users_roles_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
-- Name: t_cars id; Type: DEFAULT; Schema: public; Owner: -
--
...
-- Name: t_categories id; Type: DEFAULT; Schema: public; Owner: -
--
...
-- Name: t_users_roles id; Type: DEFAULT; Schema: public; Owner: -
--
...
-- Dependencies: 211
-- Data for Name: t_cars; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.t_cars (id, brand, model, category_id, image, price) VALUES (53, 'Автомобиль2', 'Автомобиль2', 38, '/resources/images/cabriolet.png', 80000);
INSERT INTO public.t_cars (id, brand, model, category_id, image, price) VALUES (54, 'Автомобиль3', 'Автомобиль3', 39, '/resources/images/sport_car.png', 100000);
INSERT INTO public.t_cars (id, brand, model, category_id, image, price) VALUES (55, 'Автомобиль4', 'Автомобиль4', 37, '/resources/images/suv.png', 30000);
INSERT INTO public.t_cars (id, brand, model, category_id, image, price) VALUES (52, 'Автомобиль1', 'Автомобиль1', 37, '/resources/images/sedan.png', 50000);
INSERT INTO public.t_cars (id, brand, model, category_id, image, price) VALUES (56, 'Автомобиль5', 'Автомобиль5', 37, '/resources/images/cabriolet.png', 85000);
INSERT INTO public.t_cars (id, brand, model, category_id, image, price) VALUES (57, 'Автомобиль6', 'Автомобиль6', 37, '/resources/images/sport_car.png', 73000);
INSERT INTO public.t_cars (id, brand, model, category_id, image, price) VALUES (58, 'Автомобиль7', 'Автомобиль7', 39, '/resources/images/sedan.png', 10000);


--
-- TOC entry 2874 (class 0 OID 16832)
-- Dependencies: 209
-- Data for Name: t_categories; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.t_categories (id, name) VALUES (37, 'Категория1');
INSERT INTO public.t_categories (id, name) VALUES (38, 'Категория2');
INSERT INTO public.t_categories (id, name) VALUES (39, 'Категория3');
...
INSERT INTO public.t_roles (id, name) VALUES (2, 'Manager');
INSERT INTO public.t_roles (id, name) VALUES (1, 'Admin');
...
INSERT INTO public.t_users (id, full_name, date_of_birthday, login, password) VALUES (21, 'admin', '1993-02-18', 'admin', '$2a$10$PQCJJwz9AQ16MQ8LwgEY9.mi.IEsmo.D6XjETezvuhtbQwlbk3uda');
INSERT INTO public.t_users (id, full_name, date_of_birthday, login, password) VALUES (22, 'manager', '2000-07-29', 'manager', '$2a$10$nuYHVta336uH8.ljnID6P.3a3wMfi.dAdSncj1Scus6H.WFP8rwVC');


--
-- TOC entry 2872 (class 0 OID 16807)
-- Dependencies: 207
-- Data for Name: t_users_roles; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.t_users_roles (id, user_id, role_id) VALUES (40, 21, 1);
INSERT INTO public.t_users_roles (id, user_id, role_id) VALUES (44, 22, 2);


--
-- TOC entry 2887 (class 0 OID 0)
-- Dependencies: 210
-- Name: t_cars_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
-- Dependencies: 208
-- Name: t_categories_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
-- Dependencies: 206
-- Name: t_users_roles_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
-- Name: t_cars t_cars_brand_model_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: t_cars t_cars_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: t_categories t_categories_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: t_categories t_categories_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: t_roles t_roles_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: t_users t_user_login_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: t_users t_user_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: t_users_roles t_users_roles_user_id_role_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: t_cars t_cars_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: t_users_roles t_users_roles_role_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: t_users_roles t_users_roles_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
-- Completed on 2020-06-02 16:17:00
